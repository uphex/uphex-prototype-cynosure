...
describe Uphex::Prototype::Cynosure::Shiatsu do
  ...
  it 'should return impressions' do
    ...
    allow(Uphex::Prototype::Cynosure::Shiatsu::Google::Client::Impressions).to receive(:results).with(@profile1,{:start_date=>Date.parse('20140220'),:end_date=>Date.parse('20140228')}).and_return(@profile1.impressions)
  ...
  it 'should return ad_clicks' do
    ...
    allow(Uphex::Prototype::Cynosure::Shiatsu::Google::Client::AdClicks).to receive(:results).with(@profile1,{:start_date=>Date.parse('20140220'),:end_date=>Date.parse('20140228')}).and_return(@profile1.adClicks)
  ...
  it 'should return organic_searches' do
    ...
    allow(Uphex::Prototype::Cynosure::Shiatsu::Google::Client::OrganicSearches).to receive(:results).with(@profile1,{:start_date=>Date.parse('20140220'),:end_date=>Date.parse('20140228')}).and_return(@profile1.organicSearches)
